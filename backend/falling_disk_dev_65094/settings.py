"""
Django settings for falling_disk_dev_65094 project.
...
ROOT_URLCONF = 'falling_disk_dev_65094.urls'
...
WSGI_APPLICATION = 'falling_disk_dev_65094.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_disk_dev_65094 API",
    "DESCRIPTION": "API documentation for falling_disk_dev_65094 App",
    "VERSION": "v1",
}
